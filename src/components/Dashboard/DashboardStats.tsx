...
const DashboardStats: React.FC = () => {
  ...
  const stats = data ? [
    ...
    {
      title: 'Managers',
      value: data.overview.totalManagers.toLocaleString(),
      change: calculateChange(data.overview.totalManagers, data.overview.totalManagers - 1),
      changeType: getChangeType(calculateChange(data.overview.totalManagers, data.overview.totalManagers - 1)),
      icon: Shield,
      color: 'bg-orange-500',
    },
    {
